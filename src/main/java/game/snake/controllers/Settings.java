...
public class Settings extends Controller {
    ...
    @FXML private void onPressed(ActionEvent event) throws NullPageException {
        ...
        game.snake.game.Settings.setStartSpeed(Integer.parseInt(properties.get("start")));
        game.snake.game.Settings.setSpeedProgress(Float.parseFloat(properties.get("progress")));
        game.snake.game.Settings.setPowerUpChance(Double.parseDouble(properties.get("chance")));

        page().load(new Page("Size"));
        event.consume();
    }
}